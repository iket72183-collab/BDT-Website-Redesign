# BDT Website Redesign

This folder is a deployment-ready static site for the new BDT Talent Group website redesign.
...
- `connect/`: statically exported BDT Connect product landing page and legal pages
...
- The homepage product grid links to the BDT Connect section at `/connect/`.
...
The intended next step is to create a new GitHub repository, push this folder, and optionally enable GitHub Pages from the default branch.
