...
export function ProblemSolution() {
  return (
    <section id="how" className="connect-section relative mx-auto w-full max-w-7xl scroll-mt-28 px-5 py-16 sm:px-10 sm:py-28">
      ...
      <div className="relative grid gap-4 sm:gap-6 md:grid-cols-[0.95fr_0.95fr_1.1fr] md:items-stretch">
        {items.map((it) => (
          <div
            key={it.title}
            className={
              'group relative overflow-hidden rounded-2xl p-5 sm:p-8 transition-all duration-300 ease-[var(--bdt-ease-base)] ' +
              (it.accent
